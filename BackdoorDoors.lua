...
local RSC = game.RunService.RenderStepped:Connect(function()
    ...
    if Config.Esp then
        EspLib:AddHighlight(CR[tostring(LR)].Door, Config.DoorCol)
        EspLib:AddText(CR[tostring(LR)].Door.Sign, Config.DoorCol, "Door: "..tostring(LR+1))
...
workspace.ChildAdded:Connect(function(c)
    ...
    message.Parent = script.Parent -- Assuming this script is within a ScreenGui
